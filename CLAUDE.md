...
Baseline-First xong (**Hypothesis Pass @300 = PASS**), Generalization Panel xong (quy tắc khả thi: **ĐI TIẾP**), Mechanism A1–A4 xong (chưa cơ chế nào đạt tiêu chí; hướng stage-aware đã bỏ). **Đọc [docs/synthesis_2026-09-23.md](docs/synthesis_2026-09-23.md) trước** — tổng hợp toàn cục + hướng method khả dĩ + việc mở cho phiên sau. Mechanism Stage đã đóng (2026-09-24). Pilot method (can thiệp mức loss trên OSFD): A′1 trọng số không gian = **NO-GO** @ n300 (ΔCrossAvg +0.5); P1 channel dropout bỏ trước khi chạy (≈ OSFD); P2 gộp lõm theo channel **dừng ở mechanism gate** (không giảm tập trung distortion stage 4) — xem các entry 2026-09-24 trong `docs/progress_log.md`. Theo nguyên tắc đã chốt: KHÔNG làm tiếp feature engineering kiểu P3/P4. Tập development DUY NHẤT cho RQ3: `data/image_lists/dev300.csv` (ngoài n1000; không mở rộng thêm); không bao giờ tune trên n300/n1000. Việc tiếp theo: user quyết RQ3 pivot sang nguyên lý khác hẳn (quy tắc chốt trước) hay chấp nhận kết luận âm và chuyển trọng tâm sang analysis paper.
